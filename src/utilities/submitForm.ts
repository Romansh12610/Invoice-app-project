...
type SubmitInvoiceForm = (e: React.MouseEvent<HTMLButtonElement & { name: ActionTypes }>, formState: InvoicePayload, formRef: React.RefObject<HTMLFormElement>, setShouldShowError: React.Dispatch<React.SetStateAction<boolean>>, dispatchAction: InvoiceListDispatchType, restoreToInitial: RestoreCallback, exitAnimationStateCallback?: () => void) => void;


// MAIN FUNCTION
export const submitInvoiceForm: SubmitInvoiceForm = async (e, formState, formRef, setShouldShowError, dispatchAction, restoreToInitial, exitAnimationStateCallback) => {
