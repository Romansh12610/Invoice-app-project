...
export default interface ReducerActions {
    type: 'filter' | 'openForm' | 'openFormEdit' | 'closeForm' | 'addInvoice' | 'addDraft' | 'saveChanges' | 'discardChanges' | 'closeModal' | 'openModal' | 'deleteInvoice' | 'changeStatus' | 'resetDeletedInvoice';
